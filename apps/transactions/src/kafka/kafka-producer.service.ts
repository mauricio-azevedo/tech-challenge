...
/**
 * Producer unico do servico. No boot garante os topicos e conecta; no shutdown desconecta —
 * um producer que morre sem `disconnect` deixa mensagens em voo sem confirmacao.
 */
@Injectable()
